...
public class passwordGenerator extends Application {
    ...
    public passwordGenerator(){
        ...
        readJSON(data, "passwordManager/masterkey.json", 1);
    }
    ...
    public void start(Stage primaryStage) {
        ...
        b3.setOnAction(event ->{
            ...
            writeToJson("passwordManager/data.json",0);
        });
        ...
        b4.setLayoutY(445);
        b3.setId("TempButton");
        b4.setOnAction(event -> signInPopup(masterKey, primaryStage));
    ...
    private void signInPopup(String correctPassword, Stage stage){
        ...
        submit.setOnAction(event -> {
            ...
            if(tf.getText().equals(correctPassword)){
                readJSON(data, "passwordManager/data.json", 0);
                p.hide();
            }else{
